          ...
          <nav style={{ backgroundColor: companyDetail?.data[0]?.theme?.primaryColor ? `#${companyDetail?.data[0]?.theme?.primaryColor}` : "#0f263a" }} className='h-[56px] w-full fixed top-0 left-0 z-[10] flex items-center py-[.5rem] px-[1rem]'>
            {
              ...
              <CurrencyMenu lang={lang} modal color={companyDetail?.data[0]?.theme?.secondaryColor || 'ffffff'} data={companyDetail?.data?.[0]?.currencies} />
            }
            ...
            </div>
            {
              ...
              <LangMenu lang={lang} modal color={companyDetail?.data[0]?.theme?.secondaryColor || 'ffffff'} data={companyDetail?.data?.[0]?.localizations} locale={companyDetail?.data?.[0]?.locale} />
            }
          </nav>
